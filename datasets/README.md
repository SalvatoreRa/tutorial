...
| 31.| [Long](https://raw.githubusercontent.com/SalvatoreRa/tutorial/main/datasets/long.csv)| --- | [source.](https://www.openml.org/search?type=data&status=active&id=42636) | Data for an stock long position. 20 features and 4477, last column target variable. All features numeric and no categorical features (file: CSV)|
