...
| 20.| [CO2 Emissions]()| --- | [source](https://www.kaggle.com/datasets/bhuviranga/co2-emissions) |car emission CO2, variable includes the car maker, vehicle, type of vehicle, engine and so on.  zip file (file: csv)|
