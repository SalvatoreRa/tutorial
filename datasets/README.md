...
|47.|[default-of-credit-card-clients](https://raw.githubusercontent.com/SalvatoreRa/tutorial/main/datasets/default-of-credit-card-clients.csv)|--|[source](https://www.openml.org/search?type=data&sort=runs&id=45020&status=active)|This study on customer default in Taiwan compares six data mining methods for predicting default probability. A new Sorting Smoothing Method is used to estimate true default probabilities. Regression analysis shows that artificial neural networks outperform other models, producing the most accurate estimates of the real probability of default.  (n examples: 13272, n featues: 21, classes: 2, balanced)|
|48.|[eye_movements](https://raw.githubusercontent.com/SalvatoreRa/tutorial/main/datasets/eye_movements.csv)|--|[source](https://www.openml.org/search?type=data&sort=runs&id=44130&status=active))|Eye Movements dataset, classification of the eye movements.  (n examples: 10936, n featues: 28, classes: 2, balanced)|
|49.|[jannis](https://raw.githubusercontent.com/SalvatoreRa/tutorial/main/datasets/jannis.csv)|--|[source](https://www.openml.org/search?type=data&sort=runs&id=45021&status=active)|This dataset is part of a machine learning challenge focused on supervised learning, involving 30 diverse datasets across classification and regression tasks. Each dataset has pre-formatted numerical features and varies widely in data types, distributions, and domains like medicine, finance, and text classification. The challenge aims to build automated systems ("black boxes") that can learn and predict across these datasets with minimal human intervention.  (n examples: 57580, n featues: 55, classes: 2, balanced)|
|50.|[heloc](https://raw.githubusercontent.com/SalvatoreRa/tutorial/main/datasets/heloc.csv)|--|[source](https://www.openml.org/search?type=data&sort=runs&id=45026&status=active)|Dataset used in the tabular data benchmark https://github.com/LeoGrin/tabular-benchmark, transformed in the same way.  (n examples: 10000, n featues: 23, classes: 2, balanced)|
