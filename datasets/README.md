...
|41. |[Computational humor detection](https://github.com/SalvatoreRa/tutorial/blob/main/datasets/Computational_humor.zip)| --- |[source](https://www.kaggle.com/datasets/deepcontractor/200k-short-texts-for-humor-detection)| Dataset for humor detection consisting of 200,000 formal short texts.  Total features 2, 2 classes, 200,0000 sentences. [Original article](https://arxiv.org/abs/2004.12765) (file: ZIP). |
