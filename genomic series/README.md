...
| [Logistic regression]([https://s](https://salvatore-raieli.medium.com/complete-guide-on-logistic-regression-with-gene-expression-data-the-math-1589d95236f8)) | -- | Python: Introduction to logistic regression math  |
| [Logistic regression](https://s) | [Jupiter notebook](https://github.com/SalvatoreRa/tutorial/blob/main/genomic%20series/logistic_regression.ipynb) | Python: Logistic regression, training, evaluation, inspection and solution |
&nbsp;
